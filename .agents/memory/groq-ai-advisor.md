...
**Safety boundary:** "full AI autonomy" here means autonomous parameter tuning within hardcoded bounds (see `full-ai-adaptation.md`, `profit-only-guarantee.md`), not literal AI-driven source code modification — that was intentionally not implemented due to financial/safety risk for a bot handling real custodial crypto funds.
