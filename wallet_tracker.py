...
class WalletTracker:
    ...
    # Держим расширенное окно, чтобы старые транзакции не обрабатывались
    # повторно после переполнения набора дедупликации.
    MAX_SEEN = 12000        # размер набора уже учтённых tx_hash
