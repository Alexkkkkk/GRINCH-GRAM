...
class BrainFusion:
    ...
    def _compute_fusion(self) -> FusionSignal:
        ...
        # Источник без свежего сигнала не считается согласившимся. Это
        # особенно важно при rate-limit Groq: старый BUY/SELL не должен
        # усиливать новый консенсус.
