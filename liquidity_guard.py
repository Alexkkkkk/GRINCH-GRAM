...
def _evaluate(liq: float):
    ...
    if not _buys_paused:
        ...
        if recovered:
            ...
            _buys_paused = False
            _pause_reason = ""
            # Пик не понижаем после восстановления: иначе следующий резкий
            # вывод ликвидности будет сравниваться с искусственно заниженной
            # базой и guard пропустит опасную просадку.
