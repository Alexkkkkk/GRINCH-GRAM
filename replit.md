...
✅ **Workflow запущен и работает (17.07.2026)**. Зависимости установлены через Replit package manager. Приложение поднимается на порту 5000, дашборд доступен в preview-панели.
