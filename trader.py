...
class Trader:
    def __init__(self):
        ...
        self.ai       = AIEngine()
        self.running  = False
        self.training = False          # True пока идёт предобучение
        self.trades      = []
        self.open_trades = []
        self.logs        = []
        self.last_ai     = {}
        ...
        # Колбэк прогресса обучения — устанавливается из app.py
    ...
    def _emit_progress(self, progress_dict):
        """Вызывается ai_engine при каждом шаге обучения."""
    ...
    def _open_trade(self, side, price, analysis, ai=None):
        ...
        self.log(
            f"🟢 BUY @ {price} | {stake:.2f} TON | SL={sl}(-{sl_pct:.1f}%) | "
