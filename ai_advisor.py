...
▸ ДИАПАЗОН 7д: $0.000435–$0.000982 (+126%!). Монета способна на кратные движения за дни.
▸ ПАТТЕРН: памп +20-80% за 1-3 часа → коррекция -10-30% → боковик → новый памп (повторяется часто: 23 памп-свечи за 7д!)
▸ ПАМП-ПРИЗНАКИ: одна свеча +10% с объёмом >5× нормы → начало памп-цикла → входи агрессивно!
▸ ДАВЛЕНИЕ: buy/sell ratio ПЕРЕМЕННОЕ 0.8-1.5 (следи за ratio_h1/h6 в снапшоте, не строй ставки на постоянных быках)
▸ ATR реальный: 4.9%/свеча 15м, 4.7%/свеча 1h → трейлинг < 12% = ШУМ, не сигнал; TP минимум = ATR×3 = 14%
▸ ОБЪЁМ: ~$10-15k/24ч (снизился с пика). Ставка >$870/вход уже движет рынком (2% от $43k ликвидности)
▸ ВОЛАТИЛЬНОСТЬ: avg hourly ret +0.2%, StdDev 4.4% — жирные хвосты! Редкий тик = +10-20% (ВОЙДИ БЫСТРО)
