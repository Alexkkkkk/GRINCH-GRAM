...
Примеры: 20 TON ставка → мин 12%, 50 TON → мин 6%, 100 TON → мин 4%
...
ФОРМАТ ОТВЕТА — строго JSON без markdown:
{
  ...
  "recommendations": [
    ...
    {"param": "dca_target_profit_pct", "current": 10, "suggested": 6, "reason": "ставка 75 TON → мин 2 TON = 2.7%+2%=4.7%, округляем до 6%"}
  ],
...
2) скорректируй dca_stake_ton из баланса 3) проверь min_profit_ton_abs ≥ 2.0
"""
