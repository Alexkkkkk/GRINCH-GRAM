...
class Config:
    ...
    # реальной истории, но НИКОГДА ниже этого порога в абсолютных TON.
    # Пример: 5 TON с 100 TON ставки = 5% минимум; с 200 TON = те же 5 TON = 2.5%.
    # Пол пересчитывается при каждой адаптации: floor% = MIN_PROFIT_TON/trade_amount*100
    MIN_PROFIT_TON      = float(os.getenv("MIN_PROFIT_TON", "5.0"))
