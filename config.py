...
class Config:
    ...
    # фактических потерь на сеть). Используется для честного расчёта
    # «если продать сейчас» в карточках открытых сделок.
    SELL_GAS_TON = float(os.getenv("SELL_GAS_TON", "0.1"))
